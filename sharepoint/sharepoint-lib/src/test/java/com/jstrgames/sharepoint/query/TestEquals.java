...
public class TestEquals {
	...
	private static final String EXPECTED_SCENARIO1_XML = "<Eq><FieldRef Name=\"foo\"/><Value Type=\"Text\">bar</Value></Eq>";
	...
	private static final String EXPECTED_SCENARIO2_XML = 
			"<Eq><FieldRef Name=\"foobar\"/><Value Type=\"DateTime\">" +
	...
	public void testScenario1_DefaultTypeFieldGeneratedXml() {
		...
		final Expression expression = eq(field);
